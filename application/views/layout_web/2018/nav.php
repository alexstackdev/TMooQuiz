                ...
                <li class="download">
                    ...
                    <?php if ($data_user['vip'] == 1): ?>
                        <a href="<?=base_url().'download/quiz/'.$qs['quiz_id']?>">
                            <button><i class="fa fa-download"></i> Download word</button>
                        </a>
                    <?php else: ?>
                        ...
                        <?php else: ?>
                            <button class="modalCard" data-url="<?=base_url()?>index/card_view"><i class="fa fa-download"></i> Download word</button>
                        <?php endif ?>
                    <?php endif ?>
                </li>
            <?php endif ?>
